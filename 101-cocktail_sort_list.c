...
/**
 * swap_node_ahead - swaps a node in listint_t double-linked list
 * with the node ahead
 * @list: pointer to the head af a doubly-linked list
...
/**
 * swap_node_behind - swap node in a listint_t doubly-linked list
...
/**
 * cocktail_sort_list - used for sorting a lisint_t doubly-linked list
 * in ascending order
